    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                user.save()
                login(request, user)  # creacion de cookie de la sesion
...
def tasks(request):
    # tasks = Task.objects.all() esto es para todas las tareas de todos los usuarios, lo siguiente es para filtrar por el usuario logueado
